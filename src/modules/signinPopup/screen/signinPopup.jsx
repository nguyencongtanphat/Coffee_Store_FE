        ...
        <div className="flex flex-col justify-center items-center md:flex-row">
          <div className="flex justify-center items-center">
            <div className="w-[294px] h-[310px] rounded-t-2xl md:w-[382px] md:h-[505px] md:relative md:rounded-none md:rounded-l-2xl bg-beige100 flex justify-center items-center order-1 md:order-2">
              <div className="">
                <div className="">
                  <p className="mt-5 text-orange text-b7 text-center md:text-b5 md:text-start md:mt-[70px]">
                    Đăng ký
                  </p>
                </div>
                <div className="">
                  <input
                    className="w-[198px] h-[32px] mt-[18px] p-0 pl-[11px] text-[11px] 
                                ...
                                md:w-[328px] md:h-[48px] md:text-b13 md:mt-[27px]"
                    type="tel"
                ...
                <div className="md:flex md:justify-end md:bottom-3">
                  <p className="mt-[8px] text-orange text-[11px] text-center md:mt-[30px]">
                    Đăng nhập
                  </p>
                </div>
              </div>
