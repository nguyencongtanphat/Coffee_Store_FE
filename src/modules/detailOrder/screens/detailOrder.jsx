...
function DetailOrder() {
    ...
    return (
        <div className="w-full relative">
            ...
            <p className="text-b11 md:text-b9 text-grey200 flex my-2 lg:mx-0">Ngày:&nbsp;<span className="text-orange">{FormatDate(dtInfo.createdAt)}</span></p>
            <p className="text-b11 md:text-b9 text-grey200 flex my-2 lg:mx-0">Số điện thoại:&nbsp;<span className="text-orange">{dtInfo.PhoneNumber}</span></p>
            <p className="text-b11 md:text-b9 text-grey200 flex my-2 lg:mx-0">Địa chỉ:&nbsp;<span className="text-orange">{dtInfo.Address}</span></p>
            </div>
