            ...
            <div className="flex flex-col justify-center items-center md:flex-row">
                ...
                <div className="flex justify-center items-center order-1 md:order-2">
                    ...
                    <div className="md:ml-[10px]">
                            ...
                            <div className=""> 
                                <AppButton className="w-full h-[32px] mt-[7px] text-b17 flex items-center rounded-md md:w-[342px] md:h-[53px] md:text-b10" text="Đăng nhập"  />
                            </div>
                            <div className="md:absolute md:bottom-3">
                                <p className="mt-[8px] mb-[8px] text-orange text-[11px] text-center ">Đăng ký</p>
                            </div>
                        </div>
                    </div>
                </div>
