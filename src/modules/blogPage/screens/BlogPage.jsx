    ...
    return (
        <div>
            <div className=' px-[30px] lg:px-[50px] xl:px-[30px] 3xl:px-[70px]'>
                ...
                <NewestBlogCard  image={newest.TitleImage} date={newest.Date} content={newest.Description} title={newest.Title} content_={subContent}/>
                        ...
                        blogList.map((item, index) => {
                            ...
                            return (
                                <div className='basis-full lg:basis-1/2 xl:basis-1/3' >
                                        <BlogCard image={item.TitleImage} date={item.Date} title={item.Title} content={item.Description} key={item.id}/>
                                </div>
